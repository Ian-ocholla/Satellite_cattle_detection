...
def ImageToPoints(image, mask, animal_size = 225): #change from 9 for 0.4, 25px for 0.3m and 225 for 0.1m
...
def dataset_evaluation(Ypredict, Ytest, meta_list, search_distance = SEARCH_DISTANCE, cluster_size = 225, point_path = None):
    Total_TP = 0
    Total_FP = 0
    Total_FN = 0
